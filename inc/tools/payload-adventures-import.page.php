...
<div class="wrap">
    ...
    <div class="inside">
      <form id="adventures-import-form">
        ...
        <p class="submit">
          ...
          <button type="button" class="button" id="create-month-terms"><?php echo esc_html__('Create Month Terms', 'lovetravel-child'); ?></button>
        </p>
      </form>
    </div>
  </div>
  ...
  <div class="postbox">
    ...
    <div class="inside">
      <p>
        <strong><?php echo esc_html__('Total documents:', 'lovetravel-child'); ?></strong> <span id="total-docs">0</span>
        &nbsp;|&nbsp;
        <strong><?php echo esc_html__('Total pages:', 'lovetravel-child'); ?></strong> <span id="total-pages">0</span>
        &nbsp;|&nbsp;
