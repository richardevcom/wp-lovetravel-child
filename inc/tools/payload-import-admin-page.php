                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <div class="progress-bar">
                                ...
                                <div id="progress-fill" style="width: <?php echo esc_attr($progress); ?>%;"></div>
                            </div>
                            <div class="payload-import-actions" style="margin-top:10px;">
...
<!-- Scripts & styles moved to external assets: assets/js/admin-payload-import.js & assets/css/admin-tools.css -->